...
| `COUNT`        | \`\["COUNT", varName\:string, ints\:int                                                         | var]\`                                                                       | Stores `size(ints)` into `globalVariables[varName]`.                                                         |
| `PICK_RANDOM`  | \`\["PICK\_RANDOM", varName\:string, source\:any                                                | var]\`                                                                       | If `source` is an array, picks one element; otherwise stores the value as-is. Stored in **globalVariables**. |
...
| `GET_RESOURCE` | \`\["GET\_RESOURCE", resource\:ResourceType                                                     | string, player\:Player, varName\:string]\`                                   | Reads a player resource into `globalVariables[varName]`.                                                     |
...
| Opcode           | Signature                                                                                                      | Notes                                                                                                                                                                                      |                                                                                                                                                                                                                                   |                                                                                                |                                                                                           |
| ---------------- | -------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| `SPAWN_UNIT`     | \`\["SPAWN\_UNIT", params:{ name?\:string, player\:Player, type\:UnitType                                      | string, position\:Vector2i, flags?:\["OUT\_OF\_SIGHT"], forFree?\:bool=true, force?\:bool=true, warpIn?\:bool=false, production?\:int=0, unitFactory?\:UnitId=-1, quantity?\:int=1..7 }]\` | Spawns one or more units. If `name` is set, stores spawned unit IDs in `units[name]`. `OUT_OF_SIGHT` tries to place out of enemy vision. If `unitFactory` is set, production/queue rules apply. `warpIn` plays an arrival effect. |                                                                                                |                                                                                           |
...
| `REMOVE`         | \`\["REMOVE", unitArray\:UnitId                                                                                | var]\`                                                                                                                                                                                     | Removes units from the map (not a kill).                                                                                                                                                                                          |                                                                                                |                                                                                           |
| `KILL`           | \`\["KILL", target\:Player                                                                                     | UnitId\[]                                                                                                                                                                                  | var]\`                                                                                                                                                                                                                            | If `target` resolves to a player string, kills that side. Otherwise kills the specified units. |                                                                                           |
| `SET_PLAYER`     | \`\["SET\_PLAYER", unitArray\:UnitId                                                                           | var, player\:Player]\`                                                                                                                                                                     | Transfers ownership of units to another player.                                                                                                                                                                                   |                                                                                                |                                                                                           |
| `MOVE_TOWARDS`   | \`\["MOVE\_TOWARDS", destination\:Vector2i, unitArray\:UnitId                                                  | var, options?:{ maxDistance?\:int }, subActions?\:Action ]\`                                                                                                                               | Orders units to path toward a tile. Runs `subActions` after arrival.                                                                                                                                                              |                                                                                                |                                                                                           |
| `ATTACK_TILE`    | \`\["ATTACK\_TILE", target\:Vector2i, unitArray\:UnitId                                                        | var, subActions?\:Action ]\`                                                                                                                                                               | Units attack a tile; engine chooses melee/ranged. `subActions` run after the attack animation.                                                                                                                                    |                                                                                                |                                                                                           |
| `RESET_MOVEMENT` | \`\["RESET\_MOVEMENT", selector:(Vector2i                                                                      | UnitId\[]                                                                                                                                                                                  | var                                                                                                                                                                                                                               | Player)]\`                                                                                     | Restores movement points for all units on a tile, listed units, or all units of a player. |
| `SET_HEALTH`     | \`\["SET\_HEALTH", unitArray\:UnitId                                                                           | var, params:{ percent?\:float                                                                                                                                                              | amount?\:int, delta?\:int }]\`                                                                                                                                                                                                    | Sets health by absolute `amount` or by `percent` of max, then applies `delta` if provided.     |                                                                                           |
| `UNIT_STRATEGY`  | \`\["UNIT\_STRATEGY", unitArray\:UnitId                                                                        | var, cfg:{ goal\:Goal, radius?:\[int,int], preferCover?\:bool, willScatter?\:bool, destination?\:Vector2i }]\`                                                                             | Attaches an AI strategy engine to the units. Goals include `PROTECT`, `MOVE`, `ATTACK_MOVE`, `WAIT`.                                                                                                                              |                                                                                                |                                                                                           |
| `ENABLE_UNITS`   | \`\["ENABLE\_UNITS", unitTypes:("ALL\_UNIT\_TYPES"                                                             | UnitType\[])]\`                                                                                                                                                                            | Enables listed unit types in the build UI.                                                                                                                                                                                        |                                                                                                |                                                                                           |
| `DISABLE_UNITS`  | \`\["DISABLE\_UNITS", unitTypes:("ALL\_UNIT\_TYPES"                                                            | UnitType\[])]\`                                                                                                                                                                            | Disables listed unit types in the build UI.                                                                                                                                                                                       |                                                                                                |                                                                                           |
| `SPEAK`          | \`\["SPEAK", unit\:UnitId                                                                                      | var, text\:string]\`                                                                                                                                                                       | Unit speech bubble.                                                                                                                                                                                                               |                                                                                                |                                                                                           |
| `SET_UNIT_NAME`  | \`\["SET\_UNIT\_NAME", name\:string, unitArray\:UnitId                                                         | var]\`                                                                                                                                                                                     | Sets the display name on the **first** valid unit in the array.                                                                                                                                                                   |                                                                                                |                                                                                           |
...
| `GET_TILES`     | \`\["GET\_TILES", varName\:string, { position\:Vector2i, radius\:int, excludeCenter?\:bool=false, visionIsRequired?\:bool=false, player?\:Player, canFitUnits?\:UnitId | var, canFitUnitTypes?\:UnitType }]\`           | Gathers tiles into `globalVariables[varName]` (as `Vector2i[]`). If `canFit*` is set, filters by placement rules (and optionally by `player` occupancy). |
...
| `KILL`          | *See above in Units*                                                                                                                                                                    | Used to end missions: killing `"PLAYER"` = defeat; killing `"ENEMY_PLAYER"` = victory. |
...
| Opcode        | Signature                                               | Notes  |                                                                 |
| ------------- | ------------------------------------------------------- | ------ | --------------------------------------------------------------- |
| `EMIT_AURA`   | \`\["EMIT\_AURA", auraName\:string, unitArray\:UnitId   | var]\` | Applies an aura to each unit and tracks it in the save context. |
| `CANCEL_AURA` | \`\["CANCEL\_AURA", auraName\:string, unitArray\:UnitId | var]\` | Removes an aura from each unit (and updates saved context).     |
